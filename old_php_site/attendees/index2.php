<?php	
	...
	$stmt = $handle->prepare("SELECT id, email, first_name, last_name, topic, shirt_size, twitter, reg_method, event, visible FROM barcamp_users WHERE visible = 1 AND event = 'Fall 2012' ORDER BY id ASC");
...
<body>
	...
	<div id="content">
		...
		<h2>BarCamp Rochester Fall 2012</h2>
		<?php
